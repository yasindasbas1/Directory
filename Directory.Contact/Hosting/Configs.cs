...
namespace Contact.Hosting
{
    public static class Configs
    {
        ...
        public static void ConfigureSwagger(this IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("Directory.Directory.Api.v1", new OpenApiInfo { Title = "Directory Api", Version = "v1.0" });
        ...
        public static void ConfigureSwagger(this IApplicationBuilder app, IWebHostEnvironment environment)
        {
            ...
            app.UseSwaggerUI(options =>
            {
                ...
                options.SwaggerEndpoint("/docs/Directory.Directory.Api.v1/docs.json", "Directory Api");
            });
        }
    }
}